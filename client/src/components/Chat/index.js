            ...
            ? [
                {
                  ...
                  message:
                    dir === "rtl"
                      ...
                      : `Hello ${user.firstname}, here's Shlomi and I's EasyRent's digital assistant😎,here you can mark your preferences for the apartment and we will make sure to send you an email when the rest of the relevant apartments will go up,but before you have to verify your acoount, email has sent to your email`,
                },
              ]
            : [
                // Welcome message
